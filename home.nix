          ...
          settings = {
            ...
            progress = {
              ...
              display = {
                ...
                doneTtl =
                  3; # How long a message should persist after completion
                doneIcon =
                  "✔"; # Icon shown when all LSP progress tasks are complete
                doneStyle =
                  "Constant"; # Highlight group for completed LSP tasks
                progressTtl =
            ...
            notification = {
              ...
              historySize =
                128; # Number of removed messages to retain in history
